...
export const DuplicateDetectionModal: React.FC<DuplicateDetectionModalProps> = ({
  ...
  console.log('🎭 DuplicateDetectionModal - isOpen:', isOpen, 'hasDuplicates:', detection.hasDuplicates);
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999]">
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        {/* Header */}
